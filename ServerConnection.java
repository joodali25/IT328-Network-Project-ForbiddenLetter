...
public class ServerConnection implements Runnable {
    ...
    private void showCustomResultsDialog(String data) {
        ...
        int topScore = Integer.parseInt(entries[0].split("=")[1]);
        ...
        JLabel winnerLabel = new JLabel(winners.toString() + " Win!", SwingConstants.CENTER);;
        ...
        for (String entry : entries) {
            ...
            if (winners.toString().contains(parts[0])) {
                pLabel.setForeground(new Color(180, 140, 50));
            } pLabel.setForeground(new Color(180, 140, 50));
